...
const sidebarItems = [
  { to: '/parent', icon: FaHome, label: 'Dashboard', end: true },
]
        ...
        <header className="fixed top-0 left-20 right-0 h-16 bg-white shadow-sm z-30 flex items-center justify-between px-6 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400 font-semibold -mt-0.5">Parent Portal</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 pl-3 border-l border-gray-200">
              <div className="w-9 h-9 rounded-full bg-gradient-to-br from-teal-400 to-cyan-500 flex items-center justify-center text-white font-bold text-sm shadow-md">
